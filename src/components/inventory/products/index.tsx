...
import { createCategoryApi } from "@/_api/inventory";
...
const subCategories = [
  { category: "Totes", productCount: 2 },
  { category: "Backpacks", productCount: 2 },
  { category: "Travel Bags", productCount: 2 },
  { category: "Hip Bags", productCount: 2 },
  { category: "Laptop Sleeves", productCount: 2 },
  { category: "Totes", productCount: 2 },
  { category: "Backpacks", productCount: 2 },
  { category: "Travel Bags", productCount: 2 },
  { category: "Hip Bags", productCount: 2 },
                ...
                >
                  <Dialog.Panel className="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl">
                    ...
                    <form className="mt-4 border-t border-gray-200">
                      <ul
                        role="list"
                        className="px-2 py-3 font-medium text-gray-900 bg-blue-300"
                      >
              ...
              <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4 ">
                ...
                <form className="hidden lg:block">
                  <div className="flex justify-between items-center">
                    ...
                    <p className="text-sm mb-3" onClick={addNewCategory}>
                      Add
                    </p>
                  </div>
                  <ul
                ...
                {/* Product grid */}
                <div className="lg:col-span-3 bg-green-300">
                  {/* Your content */}
